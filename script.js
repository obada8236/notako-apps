document.addEventListener("DOMContentLoaded", function () {
    ...
    const apps = [
        ...
        {
            name: "Notako-instagram",
            image: "https://scontent.famm2-3.fna.fbcdn.net/v/t1.15752-9/413946713_810689380863029_6689785407107519956_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=8cd0a2&_nc_eui2=AeGSDXEYCjudIeSe6AMwBjpEyzxXcLYbbP3LPFdwthts_eyZVK7iIoF1iX5mykR-sSe5X6TTve3pgVlhi0NJShPr&_nc_ohc=h4zdmUPkYOIAX-Q_aEd&_nc_ht=scontent.famm2-3.fna&oh=03_AdRAd09zl1dqF5LLXC-Vs7eNeg2TRL5pDvcvO2OBFly2aw&oe=65B7CB06",
            description: " الخصائص : حفظ الرسائل المحذوفة ,  تحميل المنشورات والقصص , ازالة الاعلانات ,  تأكيد الإعجاب وما إلى ذلك.",
            downloadLink: "https://ioair.link/68uaqw"
        }
    ];
    ...
    function showAppDetails(app) {
        detailsContentElement.innerHTML = `
            ...
            <a class="downloadb"href="${app.downloadLink}">Install</a>
            </div>
        `;
